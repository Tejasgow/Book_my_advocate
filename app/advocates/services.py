...
def send_sms(phone, message):
    if phone:
        ...
        # Integrate Twilio or other SMS API here
...
def get_advocate_by_id(pk):
    """
    Fetch verified advocate by ID
    """
    return get_object_or_404(AdvocateProfile, pk=pk, verified=True)
...
def assign_assistant(advocate, user_id):
    """
    ...
    if assistant_user.phone:
        send_sms(assistant_user.phone, f"You are now assistant of Advocate {advocate.user.username} ✅")
